...
*/
?>
<div class="lostpassword" id="<?php $template->the_instance(); ?>">
	...
	<form name="lostpasswordform" id="lostpasswordform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'lostpassword', 'login_post' ); ?>" method="post">
		...
		<p class="submit-wrap">
			<input type="submit" name="wp-submit" id="wp-submit<?php $template->the_instance(); ?>" value="<?php esc_attr_e( 'Get New Password', 'theme-my-login' ); ?>" class="waves-effect waves-lightbtn btn-primary btn-large"/>
